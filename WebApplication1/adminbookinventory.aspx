            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgView" width="100px" src="BooksInventory_images/books1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-warning" runat="server" Text="Update" OnClick="Button3_clcik" />
                     </div>
                     <div class="col-4">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="book_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="book_imglink" HeaderText="book_imglink" SortExpression="book_imglink" />
                            </Columns>
                         </asp:GridView>
                     </div>
                  </div>
